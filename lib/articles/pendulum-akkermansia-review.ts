...
export const pendulumAkkermansiaReview: ProductArticle = {
  ...
  category: 'wellness',
  summary:
    'The first company to sell live Akkermansia muciniphila, with one of the cleanest labels in the supplement aisle — and a dose roughly 100 times below the amount used in the only randomised human trial of this organism, which tested the heat-killed form and found the live one did nothing.',
  verdict:
  ...
  scoreBreakdown: {
    ...
    // consumer surveys. The one randomised human trial of A. muciniphila found
    // the live form did not beat placebo and found no effect on GLP-1 — which
    // is the claim printed on the box.
  ...
  seoDescription:
    'Pendulum Akkermansia is honestly labelled and 100x below the studied dose. What the one human trial found, and the $29.99 bottle with the same AFU count.',
...
<p>The Depommier trial measured plasma GLP-1 as an outcome. Supplementation did not affect it. That is the only human randomised trial of this organism to have looked, and it looked with a dose a hundred times larger than the one in this capsule.</p>
...
<p><em>A. muciniphila</em> is a normal resident of healthy human guts — typically a few per cent of the gut microbiome — and it has real safety work behind it. The Depommier trial's primary endpoints were safety and tolerability, and it passed them. This is not a stimulant, a hormone or a novel chemical.</p>
...
<p>Three things stop it settling the question. First, it is an argument, not a result: there is no published trial of this strain at this dose showing colonisation or a clinical outcome. Second, the trial evidence that does exist points the other way on the seeding logic, because the arm that worked was the <em>heat-killed</em> one, which cannot colonise anything — implying the benefit came from bacterial components rather than from a living population establishing itself. Third, AFU does not certify that the cells can grow, and growing is the entire premise of seeding.</p>
...
`,
  ...
  cons: [
    '100 million AFU against the 10 billion bacteria a day used in the only randomised human trial — a hundredfold gap, and up to 1,500-fold against the wider literature',
    'That trial found the live form did not significantly beat placebo; the pasteurised form was the one that worked',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'The carton says it does. The Depommier trial measured plasma GLP-1 directly and found supplementation did not affect it, at a hundred times this dose. That is the only human randomised trial of this organism to have measured it. Note also that the claim appears on the packaging and in the Amazon listing title but not among the headline claims on Pendulum’s own product page, which stick to gut lining and permeability. If GLP-1 is why you are considering this, read our GLP-1 explainer first.',
    },
    {
  ...
  history: [
    {
      date: '2026-09-24',
      note: 'First published. Scored 4.0 out of 10. The label transparency mark of 7 is among the higher marks on this site and is genuinely earned. It is pulled down by a dose mark of 2 — 100 million AFU against the 10 billion bacteria a day used in the only randomised human trial — and a value mark of 2, because a 90-capsule bottle with the same AFU count and more inulin sells for $29.99 against $145 here.',
    },
    {
      date: '2026-09-24',
